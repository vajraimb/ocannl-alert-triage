...
A default run on a 4-core CPU takes about 15 seconds end to end (C compilation of the routines
included) and prints:
...
There is no separate weights file: with a 15-second training run, the simplest correct flow is to
